...
(`GEMINI_API_KEY` 시크릿 필요 — **아직 등록 안 됨**).

**현재 수치**: 의미 ρ0.978 · 쉬움 ρ0.932 · 간결 ρ0.924 · 모순 9/9 ·
복붙 6/6 오탐 0/84 · 지문 자동점검 무지적 115/118.
...
- **복붙 제출의 점수 표시** — 현재 원문 복붙이 69.3점으로 상위권에 뜹니다. 플래그가
  붙어 교사 확인 대기로 가고 기각하면 팀 점수에서 빠지지만, 교사가 확인을 건너뛰면
  높은 점수가 남습니다. 플래그 시 점수를 아예 숨기는 쪽으로 바꿀 수 있습니다.
