  ...
  return (
    <main className="mx-auto max-w-[680px] px-5 py-8">
      <header>
        ...
        <h1 className="mt-2 text-2xl font-bold">바꿔 말하기 세 유형 — 한 문제씩</h1>
      ...
      <footer className="mt-8 rounded-xl bg-[var(--color-soft)] p-4 text-xs leading-relaxed text-[var(--color-muted)]">
