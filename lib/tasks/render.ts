...
const PROMPTS: Record<string, string> = {
  "1": "밑줄 친 부분을 **다른 낱말로** 다시 쓰세요. 아래 낱말은 쓰지 않습니다.",
  "2:fold": "밑줄 친 문장을 **이름(명사구) 하나로 접으세요.** 동사를 남기지 않습니다.",
  "2:unfold": "밑줄 친 이름을 **문장으로 펴세요.** 주어와 동사를 세웁니다.",
  "3:span": "밑줄 친 표현이 **앞의 무엇을 받는지** 범위를 끌어서 표시하세요.",
  "3:name": "밑줄 친 범위를 하나로 **되받는 이름**을 쓰세요.",
}
